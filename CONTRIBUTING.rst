...
Report bugs at https://github.com/AllenCellModeling/minimal_airflow/issues.
...
minimal-airflow could always use more documentation, whether as part of the
official minimal-airflow docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/AllenCellModeling/minimal_airflow/issues.
...
Ready to contribute? Here's how to set up `minimal_airflow` for local development.

1. Fork the `minimal_airflow` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/minimal_airflow.git
...
3. The pull request should work for Python 3.6 and 3.7, and for PyPy. Check
   https://travis-ci.org/AllenCellModeling/minimal_airflow/pull_requests
...
$ py.test tests.test_minimal_airflow
